...
修改文件后，重新打包（eg：dist文件夹），
```
$ sentry-cli releases -o sentry -p react-sentry files release@1.0.0 upload-sourcemaps './dist/static/js' --url-prefix '~/static/js'
```

## sentry参考
+ https://segmentfault.com/a/1190000014683598
+ https://www.e-learn.cn/content/javascript/1155199
+ https://segmentfault.com/a/1190000016975941
